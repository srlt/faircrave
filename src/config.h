...
#define FAIRCONF_SORTLIST_PRECISION 64 // Précision du type utilisé
...
#define FAIRCONF_SORTLIST_PRECISION 32 // Précision du type utilisé
...
#define FAIRCONF_THROUGHPUT_PRECISION 25   // Nombre de divisions de cette fenêtre
...
/// Conntrack
#define FAIRCONF_HOOKS_CTEXTID NF_CT_EXT_FAIRCRAVE // Nom de l'enum du l'extension apportée
